...
// API to check avaliability of cars for a given date and location
export const checkAvaliabilityofCar=async(req,res)=>{
    try {
        const {location,pickupDate,returnDate}=req.body
        // fetching all avaliable cars for a given location
        const cars=await Car.find({location,isAvaliable:true})

        // check car avaliability for a given range of date

    ...
    <div className='px-6 md:px-16 lg:px-24 xl:px-32 2xl:px-48 mt-16 text-sm max-w-7xl'>
      ...
      <div>
        {bookings.map((booking,index)=>(
          ...
          border-borderColor rounded-lg mt-5 first:mt-12 shadow-md'>
            {/* car image + info */}
            ...
            <div className='md:col-span-2'>
              ...
              <div className='flex items-start gap-2 mt-3'>
                <img src={assets.calendar_icon_colored} alt="calender icon" className='w-4 h-4 mt-1' />
                <div>
              ...
              <div className='flex items-start gap-2 mt-3'>
                <img src={assets.location_icon_colored} alt="calender icon" className='w-4 h-4 mt-1' />
                <div>

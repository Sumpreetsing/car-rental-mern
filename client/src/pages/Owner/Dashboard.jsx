     ...
     max-w-3xl'>
        {dashboardCards.map((card,index)=>(
          ...
          <div className='flex flex-wrap items-start gap-6 mb-8 w-full'>
            {/*recent bookings */}
            <div className='p-4 md:p-6 border border-borderColor rounded-md shadow-md max-w-lg w-full'>
            ...
            {/* Monthly revenue  */}
            <div className='p-4 md:p-6 mb-6 border border-borderColor rounded-md w-full shadow-md md:max-w-xs'>

...
const AddCar = () => {
  ...
  return (
    <div className='px-4 py-10 md:px-10 flex-1'>
      <Title title="Add new Car" subTitle="Fill in the details to list a new car for booking, including car
      pricing, availability and specifications"/>
      <form onSubmit={onSubmitHandler}>
        {/* car image */}
        <div className='flex items-center gap-2 w-full'>
          <label htmlFor="car-image">
            <img src={image ? URL.createObjectURL(image) : assets.upload_icon} alt="upload icon"  className='h-16 rounded
            cursor-pointer'/>
        ...
        <div className='flex flex-col w-full'>
          ...
          <div className='flex flex-col w-full'>
            ...
            <textarea  rows={5} placeholder="Luxurious SUV with a spacious interior and a powerfull engine" required
            className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none' 
            value={car.pricePerDay} onChange={e=> setCar({...car,pricePerDay:e.target.value})}>
            </textarea>
